 ...
 * @api public
 */
Decimal.fromNumber = function(precision, number) {
 ...
 * @api public
 */
Decimal.fromString = function(precision, str) {
 ...
 * @api public
 */
Decimal.prototype.leq = function(other) {
    var maxPrecision = Math.max(this.precision, other.precision);
 ...
 * @api public
 */
Decimal.prototype.geq = function(other) {
    var maxPrecision = Math.max(this.precision, other.precision);
